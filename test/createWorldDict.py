...
for country in world_country:
    country_split_s = country.split("-")
    for country_split in country_split_s:
        if not re.match(r'^\d+$', country_split):
            names_keywords.add(country_split)

with open('templates/ext_world_dict.dic', 'w', encoding='utf-8') as file:
